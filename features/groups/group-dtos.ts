...
export type GroupStatusDto = "Customer" | "Prospect" | "Churned" | "Lead";
...
const groupStatusSeeds = [
  "Customer",
  "Prospect",
  "Churned",
  "Lead",
] satisfies GroupStatusDto[];
...
export const groupsSeed: GroupDto[] = Array.from(
  ...
  (_, index) => {
    ...
    return {
      ...
      arr: `$${arr.toFixed(1)}M`,
      status: faker.helpers.arrayElement(groupStatusSeeds),
